var bigd_site = "https://ngdc.cncb.ac.cn/";
...
function prependHeaderSection() {
    ...
    var header = "<header>" +
        ...
        "<span class='bigd-icon-bar'></span> " +
        "</button> " +
	"<a href='https://www.cncb.ac.cn'" + "' class='bigd-navbar-brand'><img src='" + bigd_site + "cdn/image/cncb-nav.png' class='bigd-img-responsive'/></a>" +
...
function appendFooterSection() {
    ...
    var footer = "" +
        ...
        "<a href='" + bigd_site + "'><img src='" + bigd_site + "cdn/image/CNCB-NGDC.png' class='bigd-img-responsive' style='margin-top: 15px;'/></a>" +
        ...
        "<li><a href='https://ngdc.cncb.ac.cn/ewas' target='_blank'>EWAS Atlas</a></li> " +
        ...
        "<li><a href='https://ngdc.cncb.ac.cn/idog' target='_blank'>iDog</a></li> " +
        "<li><a href='https://ngdc.cncb.ac.cn/methbank' target='_blank' title='Methylation DataBank'>MethBank</a></li> " +
        "</ul> " +
        "</div> " +
	...
	"<div class='bigd-col-md-2'> " +
        ...
        "<ul class='bigd-list-unstyled'> " +
        "<li><a href='https://ngdc.cncb.ac.cn/bhbd-alliance'>BHBD</a></li> " +
        ...
        "</p>"+
        "<p class='bigd-text-muted'><span><a rel='license' target='_blank' href='http://creativecommons.org/licenses/by/3.0/cn/'><img alt='Creative Commons License' style='border-width:0;height: 15px' src='"+bigd_site+"cdn/image/cc.png'/></a></span> This work is licensed under a <span><a rel='license' href='http://creativecommons.org/licenses/by/3.0/cn/' target='_blank'>Creative Commons Attribution 3.0 China Mainland License</a><br><a href='https://beian.miit.gov.cn' target='_blank'>京ICP备10050270号</a></span>" +
        "</p>" +
        "</div>" +
        "<div class='bigd-col-md-4'> <div class='pull-right'>" +
        "<ul class='bigd-list-inline'>" +
        "<li><a href='http://english.big.cas.cn' target='_blank'><img src='" + bigd_site + "cdn/image/big_logo.png' style='width: 32px'></a></li>" +
        "<li><a href='http://www.picb.ac.cn/picb' target='_blank'><img src='" + bigd_site + "cdn/image/picb" +
        ".png' style='height: 32px;'></a></li>" +
        "<li><a href='http://english.ibp.cas.cn/' target='_blank'><img src='" + bigd_site + "cdn/image/ibp.png' style='height: 32px;'></a></li>" +
        "<li><a href='http://english.cas.cn/' target='_blank'><img src='" + bigd_site + "cdn/image/cas.png' style='height: 32px;'></a></li>" +
        "</ul>" +
        "</div>" +
        "</div>" +
        "</div>" +
